...
# Erstelle 35 Testfragebögen
for quizNum in range(35):
    # Erstelle die Dateien für die Frage und Lösungsbögen
    ...
    # Durchlaufen aller 50 Staaten und erstellen einer Frage für jeden for questionNum in Range(50)
    for questionNum in range(50):
        # richtige und falsche Antworten abrufen
        ...
        # antwortbogen in file schreiben
